...
// Logo + Foundation slice — typography substrate.
// Inter: sans-serif body / UI. JetBrains Mono: code blocks + mono caption row.
// `display: "swap"` keeps text rendered with the system fallback until the
// webfont arrives, avoiding FOIT and matching Vercel's default for next/font.
const inter = Inter({
  subsets: ["latin"],
  display: "swap",
  variable: "--font-inter",
...
export const metadata: Metadata = {
  ...
  // Logo + Foundation slice — favicon ladder. PNGs generated by
  // scripts/gen-favicon.mjs from public/brand/astrant-mark-dark.png.
  icons: {
    icon: [
...
const jsonLd = [
  {
    ...
    // Logo + Foundation slice — fixed prior 404 (the old astrant-wordmark-dark.svg
    // never existed under public/). ImageObject form lets us declare actual
    // dimensions so consumers don't need to fetch and measure.
    logo: {
      "@type": "ImageObject",
